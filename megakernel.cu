...
// Pipeline: 3-stage  K-iters: 24  MMA/iter: 1  idesc: 0x08200010
...
#define N_STAGES       3
#define OFF_TMEM_0     24576
#define OFF_TMEM_1     24580
#define OFF_TMA_MBAR   24592
#define OFF_MMA_MBAR   24616
#define SMEM_BYTES     24640
...
uint64_t make_smem_desc(uint32_t addr) {
    ...
    d |= (6ULL << 61);           // bits [63:62] layout_type=3 (SWIZZLE_32B)
    return d;
}
...
patch_embed_gemm(
    ...
    static constexpr int off_a[N_STAGES] = {0, 8192, 16384};
    static constexpr int off_b[N_STAGES] = {4096, 12288, 20480};
