...
EXPERIMENTS=(
    ...
    "w3_rowsteal|make -B fc2-w3-rowsteal|./fc2-w3-rowsteal"
    "w3_tail|make -B fc2-w3-tail|./fc2-w3-tail"
    "w3_tail_lean|make -B fc2-w3-tail-lean|./fc2-w3-tail-lean"
    ...
    "w3_lean_gemm|make -B fc2-w3-lean DFLAGS=-DGEMM_ONLY|./fc2-w3-lean"
    "w3_sched_gemm|make -B fc2-w3-sched DFLAGS=-DGEMM_ONLY|./fc2-w3-sched"
    "w3_rowsteal_gemm|make -B fc2-w3-rowsteal DFLAGS=-DGEMM_ONLY|./fc2-w3-rowsteal"
    "w3_tail_gemm|make -B fc2-w3-tail DFLAGS=-DGEMM_ONLY|./fc2-w3-tail"
    "w3_tail_lean_gemm|make -B fc2-w3-tail-lean DFLAGS=-DGEMM_ONLY|./fc2-w3-tail-lean"
    "w3_dgswizzle_gemm|make -B fc2-w3-dgswizzle DFLAGS='-DNO_PREFILL -DGEMM_ONLY'|./fc2-w3-dgswizzle"
    "w3_zorder_gemm|make -B fc2-w3-zorder DFLAGS='-DNO_PREFILL -DGEMM_ONLY'|./fc2-w3-zorder"
    ...
    "w3_rowsteal_strip|make -B fc2-w3-rowsteal DFLAGS=-DSTRIP_EPILOGUE|./fc2-w3-rowsteal"
    "w3_tail_strip|make -B fc2-w3-tail DFLAGS=-DSTRIP_EPILOGUE|./fc2-w3-tail"
    "w3_tail_lean_strip|make -B fc2-w3-tail-lean DFLAGS=-DSTRIP_EPILOGUE|./fc2-w3-tail-lean"
