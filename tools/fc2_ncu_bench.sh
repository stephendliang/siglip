...
BINARIES=(
    ...
    "w3_sched|make -B fc2-w3-sched DFLAGS=-DPACKED_TILES|./fc2-w3-sched|fc2_w3_kernel|"
    "w3_rowsteal|make -B fc2-w3-rowsteal DFLAGS=-DPACKED_TILES|./fc2-w3-rowsteal|fc2_w3_kernel|"
    "w3_tail|make -B fc2-w3-tail DFLAGS=-DPACKED_TILES|./fc2-w3-tail|fc2_w3_kernel|"
    "w3_tail_lean|make -B fc2-w3-tail-lean DFLAGS=-DPACKED_TILES|./fc2-w3-tail-lean|fc2_w3_kernel|"
