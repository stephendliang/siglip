...
# ── FC2 NP kernel (non-persistent variant of fc2_w3x: 1 cluster / tile) ──
fc2-np: fc2_np.cu
	$(NVCC) $(CFLAGS) $(DFLAGS) $< -o $@ $(LDFLAGS)
...
fc2-w3x-ncu: fc2_w3x.cu
	$(NVCC) $(CFLAGS) $(DFLAGS) -DNCU_PROFILE $< -o $@ $(LDFLAGS)

fc2-w3x-ncu-strip: fc2_w3x.cu
